...
public sealed class ModelVillager : ModelBase
{
    ...
    public ModelVillager(float expansion, float yOffset)
    {
        ...
        _head.addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, expansion);
        _head.addBox(-1.0F, -3.0F, -6.0F, 2, 4, 2, expansion);
        _head.setRotationPoint(0.0F, yOffset, 0.0F);

        _body = new ModelPart(16, 20).setTextureSize(64, 64);
        _body.addBox(-4.0F, 0.0F, -3.0F, 8, 12, 6, expansion);
        _body.addBox(-4.0F, 0.0F, -3.0F, 8, 18, 6, expansion + 0.5F);
        _body.setRotationPoint(0.0F, yOffset, 0.0F);

        _arms = new ModelPart(44, 22).setTextureSize(64, 64);
        _arms.addBox(-8.0F, -2.0F, -2.0F, 4, 8, 4, expansion);
        _arms.addBox(4.0F, -2.0F, -2.0F, 4, 8, 4, expansion);
        _arms.addBox(-4.0F, 2.0F, -2.0F, 8, 4, 4, expansion);
