...
public class Item
{
    ...
    public static Item Lead = (new ItemLead(164)).setTexturePosition(4, 10).setItemName("leash");
    public static Item NameTag = (new Item(165)).setTexturePosition(3, 10).setItemName("nameTag");
    public static Item IronNugget = (new Item(169)).setTexturePosition(4, 14).setItemName("ironNugget");
    public static Item Elytra = (new ItemElytra(170)).setTexturePosition(0, 9).setItemName("elytra");
    public static Item FireworkRocket = (new ItemFireworkRocket(171)).setTexturePosition(9, 12).setItemName("fireworks");
    public static Item ArmorStand = (new ItemArmorStand(172)).setTexturePosition(8, 12).setItemName("armorStand");
    public static Item EndCrystal = (new ItemEndCrystal(173)).setTexturePosition(6, 2).setItemName("endCrystal");
    public static Item TotemOfUndying = (new ItemTotemOfUndying(174)).setTexturePosition(2, 14).setItemName("totem");
    public static Item TntMinecart = (new ItemMinecart(175, 3)).setTexturePosition(7, 12).setItemName("minecartTnt");
    public static Item RabbitStew = (new ItemSoup(176, 10)).setTexturePosition(5, 13).setItemName("rabbitStew");
    public static Item Salmon = (new ItemFood(177, 2, false)).setTexturePosition(6, 12).setItemName("fishSalmon");
    public static Item TropicalFish = (new ItemFood(178, 1, false)).setTexturePosition(6, 10).setItemName("fishTropical");
    public static Item Pufferfish = (new ItemPufferfish(179)).setTexturePosition(6, 11).setItemName("pufferfish");
    public static Item Beetroot = (new ItemFood(180, 1, false)).setTexturePosition(1, 12).setItemName("beetroot");
    public static Item ChorusFruit = (new ItemChorusFruit(181)).setTexturePosition(0, 11).setItemName("chorusFruit");
    public static Item BeetrootSoup = (new ItemSoup(182, 6)).setTexturePosition(3, 12).setItemName("beetrootSoup");
