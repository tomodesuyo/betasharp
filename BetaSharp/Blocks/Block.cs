...
public class Block
{
    ...
    public static readonly Block ActivatorRail = new BlockActivatorRail(157, 190).setHardness(0.7F).setSoundGroup(SoundMetalFootstep).setBlockName("activatorRail").IgnoreMetaUpdates();
    ...
    public static readonly Block Barrier = new BlockBarrier(166).setHardness(-1.0F).setResistance(6000000.0F).setBlockName("barrier").disableStats().IgnoreMetaUpdates();
    ...
    static Block()
    {
        ...
        Item.ITEMS[Barrier.id] = new ItemBarrier(Barrier.id - 256);
